...
int main(void)
{
	...
	int a_dest = my_i * q + (my_j - my_i + q) % q;
	int b_dest = (my_i - my_j + q) % q * q + my_j;
	int a_sourse = my_i * q + (my_j + my_i) % q;
	int b_sourse = (my_i + my_j) % q * q + my_j;
	...
	a_dest = my_i * q + (my_j - 1 + q) % q;
	b_dest = (my_i - 1 + q) % q * q + my_j;
	a_sourse = my_i * q + (my_j + 1) % q;
	b_sourse = (my_i + 1) % q * q + my_j;
